...
<body <?php body_class(); ?>>
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary">
			<?php esc_html_e('Skip to content', 'jewellery'); ?>
		</a>
		<header>
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="nav-account col-2 d-flex justify-content-end">
						<a href="#">Login/Register</a>
					</div>
					<div class="nav-icons col-2 d-flex justify-content-end">
						<div class="nav-search"><button id="search"><svg xmlns="http://www.w3.org/2000/svg" width="24"

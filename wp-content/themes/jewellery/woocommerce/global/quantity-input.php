...
<div class="quantity-counter d-flex">
	<button class="quantity-btn minus" onclick="quantity_decrement(<?php echo esc_attr($input_id); ?>)">-</button>
	<input type="text" id="<?php echo esc_attr($input_id); ?>"
		class="quantity-input text-center <?php echo esc_attr(join(' ', (array) $classes)); ?>"
	...
	<button class="quantity-btn plus" onclick="quantity_increment(<?php echo esc_attr($input_id); ?>)">+</button>
</div>
